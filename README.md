...
- **DoIP Server**: Handles routine activation and UDS diagnostic messages
- **DoIP Client**: Sends diagnostic requests and routine activation commands
- **UDS Support**: Implements Read Data by Identifier service (0x22)
- **Routine Activation**: Supports routine activation requests and responses
- **Protocol Compliance**: Follows DoIP protocol specifications
...
- **Configurable Routine IDs**: Define in YAML configuration
- **Response Codes**: Customize success and error responses
- **Conditions**: Document routine requirements
- **Validation**: Automatic routine validation
...
- **Fast Execution**: No server startup required (runs in ~0.06s)
...
- **Configuration Tests**: Server configuration loading
