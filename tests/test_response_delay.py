...
class TestResponseDelay(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.mock_config_manager.get_server_binding_info.return_value = (
            "127.0.0.1",
            13400,
        )
        self.mock_config_manager.get_network_config.return_value = {
            "max_connections": 5,
            "timeout": 30,
        }
        ...
        self.mock_config_manager.get_logging_config.return_value = {
            "level": "INFO",
            "format": "%(message)s",
            "file": None,
        }
        ...
        with patch(
            "src.doip_server.doip_server.HierarchicalConfigManager",
    ...
    def test_get_response_delay_service_level(self):
        ...
        self.mock_config_manager.get_uds_service_by_request.return_value = (
            service_config
        )
    ...
    def _create_doip_diagnostic_message(self, uds_request, source_addr, target_addr):
        ...
        )  # Diagnostic message payload type
