...
from doip_client.doip_client import DoIPClientWrapper, start_doip_client, create_doip_request
...
class TestDoIPClientWrapperExtended:
    ...
    def test_send_diagnostic_message_with_timeout(self, mock_doip_client):
        ...
        assert result == b'\x62\xF1\x90\x01\x02\x03'
        mock_client_instance.send_diagnostic_message.assert_called_once_with(b'\x22\xf1\x90', timeout=5.0)
    ...
    def test_send_routine_activation_success(self, mock_doip_client):
        ...
        mock_client_instance.send_diagnostic_message.assert_called_once_with(b'\x31\x01\x02\x02\x01', timeout=2.0)
    ...
    def test_send_read_data_by_identifier_success(self, mock_doip_client):
        ...
        assert result == b'\x62\xF1\x90\x01\x02\x03'
        mock_client_instance.send_diagnostic_message.assert_called_once_with(b'\x22\xf1\x90', timeout=2.0)
    ...
    def test_send_tester_present_success(self, mock_doip_client):
        ...
        mock_client_instance.send_diagnostic_message.assert_called_once_with(b'\x3e\x00', timeout=2.0)
    ...
    def test_send_diagnostic_session_control_success(self, mock_doip_client):
        ...
        mock_client_instance.send_diagnostic_message.assert_called_once_with(b'\x10\x03', timeout=2.0)
