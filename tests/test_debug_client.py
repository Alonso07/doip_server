...
class TestDebugDoIPClient:
        ...
        return {
            ...
            "uds_services": {
                ...
                "read_data_by_identifier": {
                    "data_identifiers": ["0xF190", "0xF191"]
                },
                "routine_control": {
            ...
            "test_scenarios": [
                ...
                },
                {
                    ...
                    "steps": ["connect", "diagnostic_session_control", "read_data_by_identifier", "disconnect"]
                }
            ]
        }
    ...
    def test_send_diagnostic_message_success(self, mock_doip_client, temp_config_file):
        ...
        mock_client_instance = Mock()
        mock_client_instance.send_diagnostic_message.return_value = b'\x62\xF1\x90\x01\x02\x03'
        mock_doip_client.return_value = mock_client_instance
    ...
    @patch('doip_client.debug_client.DoIPClient')
    def test_send_diagnostic_message_with_bytes(self, mock_doip_client, temp_config_file):
    ...
    @patch('doip_client.debug_client.DoIPClient')
    def test_send_diagnostic_message_exception(self, mock_doip_client, temp_config_file):
        """Test diagnostic message sending with exception"""
        mock_client_instance = Mock()
        mock_client_instance.send_diagnostic_message.side_effect = Exception("Send failed")
        mock_doip_client.return_value = mock_client_instance
    ...
    def test_send_alive_check_exception(self, mock_doip_client, temp_config_file):
        ...
        mock_client_instance = Mock()
        mock_client_instance.send_alive_check.side_effect = Exception("Alive check failed")
        mock_doip_client.return_value = mock_client_instance
    ...
    @patch('doip_client.debug_client.DoIPClient')
    def test_run_test_scenario_connect_failure(self, mock_doip_client, temp_config_file):
    ...
    @patch('doip_client.debug_client.DoIPClient')
    def test_run_test_scenario_diagnostic_session_control(self, mock_doip_client, temp_config_file):
    ...
    @patch('doip_client.debug_client.DoIPClient')
    def test_run_test_scenario_read_data_by_identifier(self, mock_doip_client, temp_config_file):
    ...
    @patch('doip_client.debug_client.DoIPClient')
    def test_run_test_scenario_routine_control(self, mock_doip_client, temp_config_file, sample_config):
        ...
        try:
            mock_client_instance = Mock()
            mock_client_instance.send_diagnostic_message.return_value = b'\x71\x01\x02\x02\x01'
            mock_doip_client.return_value = mock_client_instance
    ...
    @patch('doip_client.debug_client.DoIPClient')
    def test_run_test_scenario_tester_present(self, mock_doip_client, temp_config_file, sample_config):
    ...
    @patch('doip_client.debug_client.DoIPClient')
    def test_run_test_scenario_invalid_uds_request(self, mock_doip_client, temp_config_file, sample_config):
    ...
    @patch('doip_client.debug_client.DoIPClient')
    def test_run_test_scenario_reconnect(self, mock_doip_client, temp_config_file, sample_config):
    ...
    @patch('doip_client.debug_client.DoIPClient')
    def test_run_test_scenario_valid_uds_request(self, mock_doip_client, temp_config_file, sample_config):
