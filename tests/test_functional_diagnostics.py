...
class TestFunctionalDiagnostics(unittest.TestCase):
    ...
    def test_functional_diagnostic_message_basic(self):
        ...
        self.assertEqual(response, b'\x62\xF1\x90\x10\x20\x01\x12\x23\x34\x45\x67\x78\x89\xAA\xBB')
    ...
    def test_functional_address_restoration_on_error(self):
        ...
        # Mock error
        self.client.doip_client.send_diagnostic_message.side_effect = Exception("Network error")
...
class TestFunctionalDiagnosticsIntegration(unittest.TestCase):
    ...
    def test_functional_demo_execution(self):
        ...
        client.doip_client.send_diagnostic_message = Mock(return_value=b'\x50\x03\x00\x00')
