...
class TestNoResponseSimple:
    ...
    def test_no_response_warning_with_responses(self):
        ...
        assert result is True, "Validation should pass even with conflicting configuration"
    ...
    def test_no_response_with_responses_ignored(self):
        ...
        assert result is None, "Should return None when no_response is True, ignoring responses"
        assert len(responses) == 2, "Responses should still exist in config but be ignored"
    ...
    def test_no_response_default_behavior(self):
        ...
        assert result == "0x620C018000", "Should return response when no_response is False"
    ...
    def test_no_response_validation_direct(self):
        ...
        result = config_manager.validate_configs()
        assert result is True, "Validation should pass with valid no_response configuration"
